...
interface JQueryGenericPromise<T> {
   ...
   */
  then<U>(doneFilter: (value?: T, ...values: any[]) => any, failFilter?: (...reasons: any[]) => any, progressFilter?: (...progression: any[]) => any): JQueryPromise<U>;
...
interface JQueryPromiseOperator<T, U> {
  (callback1: any, ...callbacksN: any[]): JQueryPromise<U>;
}
...
interface JQueryPromise<T> extends JQueryGenericPromise<T> {
   ...
   */
  always(alwaysCallback1?: any, ...alwaysCallbacksN: any[]): JQueryPromise<T>;
  /**
   ...
   */
  done(doneCallback1?: any, ...doneCallbackN: any[]): JQueryPromise<T>;
  /**
   ...
   */
  fail(failCallback1?: any, ...failCallbacksN: any[]): JQueryPromise<T>;
  /**
   * Add handlers to be called when the Deferred object generates progress notifications.
   *
   * @param progressCallbacks A function, or array of functions, to be called when the Deferred generates progress notifications.
   */
  progress(progressCallback1?: any, ...progressCallbackN: any[]): JQueryPromise<T>;
...
interface JQueryDeferred<T> extends JQueryGenericPromise<T> {
   ...
   * @param alwaysCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved or rejected.
   */
  always(alwaysCallback1?: any, ...alwaysCallbacksN: any[]): JQueryDeferred<T>;
  /**
   * Add handlers to be called when the Deferred object is resolved.
   *
   * @param doneCallbacks1 A function, or array of functions, that are called when the Deferred is resolved.
   * @param doneCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is resolved.
   */
  done(doneCallback1?: any, ...doneCallbackN: any[]): JQueryDeferred<T>;
  /**
   * Add handlers to be called when the Deferred object is rejected.
   *
   * @param failCallbacks1 A function, or array of functions, that are called when the Deferred is rejected.
   * @param failCallbacks2 Optional additional functions, or arrays of functions, that are called when the Deferred is rejected.
   */
  fail(failCallback1?: any, ...failCallbacksN: any[]): JQueryDeferred<T>;
  /**
   * Add handlers to be called when the Deferred object generates progress notifications.
   *
   * @param progressCallbacks A function, or array of functions, to be called when the Deferred generates progress notifications.
   */
  progress(progressCallback1?: any, ...progressCallbackN: any[]): JQueryDeferred<T>;
...
interface JQueryStatic {
   ...
   */
  when<T>(...deferreds: Array<any>): JQueryPromise<T>;
...
interface JQuery {
   ...
   */
  attr(attributeName: string, func: (index: number, attr: string) => any): JQuery;
  /**
   * Set one or more attributes for the set of matched elements.
   *
   ...
   */
  css(propertyName: string, value: (index: number, value: string) => any): JQuery;
  /**
   * Set one or more CSS properties for the set of matched elements.
   *
   * @param properties An object of property-value pairs to set.
   ...
   */
  height(value: any): JQuery;
  /**
   * Set the CSS height of every matched element.
   *
   * @param func A function returning the height to set. Receives the index position of the element in the set and the old height as arguments. Within the function, this refers to the current element in the set.
   */
  height(func: (index: number, height: number) => any): JQuery;
   ...
   */
  width(func: (index: number, width: number) => any): JQuery;
   ...
   */
  after(func: (index: number, html: string) => any): JQuery;
   ...
   */
  before(func: (index: number, html: string) => any): JQuery;
